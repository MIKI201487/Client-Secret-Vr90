javascript:(()=>{
    ...
    const d = async() => {
        ...
        Se.className = u.sidebarPaths, E("Search", "fas fa-search", te), E("Gamemodes", "fas fa-gamepad", s), E("Favorites", "fas fa-star", m), (ee = E("Leaderboard", "fas fa-trophy", a)).style.display = "none", E("Logs", "fas fa-terminal", Q), E("Settings", "fas fa-cog", xe), E("Credits", "fas fa-code", d), E("Tools", "fas fa-wrench", toolsPage), F.append(Se); // Added Tools tab
